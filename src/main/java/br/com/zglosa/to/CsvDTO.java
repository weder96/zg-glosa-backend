...
public class CsvDTO {
    ...
    private String numeroSoliciacaoInternacao;
    ...
    public String getNumeroSoliciacaoInternacao() {
        return numeroSoliciacaoInternacao;
    }

    public void setNumeroSoliciacaoInternacao(String numeroSoliciacaoInternacao) {
        this.numeroSoliciacaoInternacao = numeroSoliciacaoInternacao;
    }
